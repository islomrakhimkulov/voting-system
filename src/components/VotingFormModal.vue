            ...
            <div class="flex">
              <div class="w-1/2 border-r-[1px] border-gray-45">
                <div class="bg-gray-3000 py-5 px-7 rounded-t-md">
                  <!-- title -->
                  <h2 class="text-[22px] font-semibold">Mavzu qo'shish</h2>
                  <p>{{ edit }}</p>

                  <!-- form content -->
                  <div class="py-2">
                    <div class="flex flex-col py-2">
                      <label class="text-gray-35 text-[16px] pb-1" for="title"
                        >Mavzu
              ...
              <div class="w-1/2">
                <div class="px-7 py-5">
                  ...
                  <!-- time -->
                  <div class="pb-2">
                    <h2 class="pb-3 text-gray-900 uppercase text-[16px]">
                      Ajratilgan vaqt
                    </h2>
                    <!-- time component -->
                    <div>
                  ...
                  <div>
                    ...
                    <div class="flex gap-5">
                      <AppButton color="success" class="w-full">
                        Qo'shilaman</AppButton
                      >
                      <AppButton color="danger" class="w-full">
                        Qarshiman</AppButton
                      >
                      <AppButton color="warning" class="w-full">
