			...
			<div class="flex">
				<div class="w-[75%]">
					<div>
						...
						<!-- subject title name -->
						<div
							class="text-[18px] pb-3 text-gray-900 font-semibold uppercase"
						>
							ABOUT NEW INDUSTRY OF ALL REGIONS AND THEIR LIVES,
							WHAT DO THOSE WHO ARE POOR NEED AND GOVERNMENT
						...
						<div class="bg-primary-10 p-3 mb-4 rounded">
							<h2 class="pb-1 text-gray-5">
								Barcha natijalarni yuklab olish
							</h2>
							<AppButton color="accent" size="small"
								>Yuklab olish</AppButton
							>
						</div>
						...
						<div class="bg-primary-10 mt-4 p-5 rounded">
							...
							<div class="overflow-y-scroll h-[550px] scroller">
								<div class="pb-2">
									...
									<!-- subject item title -->
									<div
										class="text-[16px] pb-2 text-gray-900 font-semibold"
									>
									...
									<p
										class="text-[15px] pb-2 pr-8 text-gray-400"
									>
